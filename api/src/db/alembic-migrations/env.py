...
# NOTE: Make sure to import all models here that you want to be considered for migrations
# from db.models import heroModel, posts  # Import all models here!
import db.models  # Auto-import all models with __init__.py
